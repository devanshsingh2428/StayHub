...
const FeaturedDestination = () => {
  return (
    <div className='flex w-full flex-col justify-center items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20' >
      ...
      <button className='my-16  px-4 py-2 text-md font-medium border border-gray-300 rounded bg-white hover:bg-gray-50 transition-all cursor-pointer text-gray-500' >Explore more Hotels...</button>
    </div>
  );
};
