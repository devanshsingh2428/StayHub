    ...
    >
      ...
      <div className="hidden md:flex items-center gap-6">
        <img
          ...
          alt="search"
          className={`${isScrolled && 'invert'} h-9 transition-all duration-500`}
        />
      ...
      >
        ...
        {!user && <button
          onClick={openSignIn}
          className={`px-8 py-2.5 rounded-full  cursor-pointer transition-all duration-500 ${isScrolled ? 'text-white bg-black' : 'bg-white text-black'}`}
        >
          Login
        </button>}
      </div>
